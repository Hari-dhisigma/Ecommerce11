...
function Signup() {
  ...
  useEffect(() => {
    axios
      .get(
        "https://ln74u03ot3.execute-api.us-west-2.amazonaws.com/countryselect"
      )
      .then((res) => {
  ...
  const insert = () => {
    ...
    axios
      .post(
        "https://mp61zfps83.execute-api.us-west-2.amazonaws.com/userinsert",
        dt
      )
      .then(function (res) {
        console.log(res.data);
  ...
  const countrySelect = (event) => {
    ...
    axios
      .post(
        "https://f6lsbv1nx8.execute-api.us-west-2.amazonaws.com/statefetch",
        dt
      )
      .then(function (res) {
  ...
  return (
    <div class="containerSignup">
      <h1>Add an address so that you can get paid</h1>
      <h3>This will be used as your default business address</h3>
